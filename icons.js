...
/* Returns inline SVG markup — no external dependency needed */
...
function icon(name, size, cls) {
  ...
  const icons = {
    ...
    /* Category Icons */
    'plane':         `<path d="M17.8 19.2L16 11l3.5-3.5C21 6 21.5 4 21 3c-1-.5-3 0-4.5 1.5L13 8 4.8 6.2c-.5-.1-.9.1-1.1.5l-.3.5c-.2.4-.1.9.3 1.1L9 12l-2 3H4l-1 1 3 2 2 3 1-1v-3l3-2 3.7 5.3c.2.4.7.5 1.1.3l.5-.3c.4-.2.6-.6.5-1.1z"/>`,
    ...
    'wallet':        `<path d="M20 12V8H6a2 2 0 01-2-2c0-1.1.9-2 2-2h12v4"/><path d="M4 6v12c0 1.1.9 2 2 2h14v-4"/><circle cx="18" cy="12" r="1"/>`,
    ...
    'file-spreadsheet': `<path d="M14 2H6a2 2 0 00-2 2v16a2 2 0 002 2h12a2 2 0 002-2V8z"/><polyline points="14 2 14 8 20 8"/><line x1="8" y1="13" x2="16" y2="13"/><line x1="8" y1="17" x2="16" y2="17"/><line x1="12" y1="13" x2="12" y2="17"/>`,
    ...
    'shield-check':  `<path d="M12 22s8-4 8-10V5l-8-3-8 3v7c0 6 8 10 8 10z"/><polyline points="9 12 11.5 14.5 15.5 10"/>`,
    ...
    'wand':          `<path d="M15 4V2"/><path d="M15 16v-2"/><path d="M8 9h2"/><path d="M20 9h2"/><path d="M17.8 11.8L19 13"/><path d="M15 9h0"/><path d="M17.8 6.2L19 5"/><path d="M11 6.2L9.7 5"/><path d="M11 11.8L9.7 13"/><path d="M8 15h8l4 6H4l4-6z"/>`,
...
/* Category icon map — maps category id to SVG icon name */
const CAT_ICON_MAP = {
  travel: 'plane', food: 'utensils', utilities: 'zap', office: 'briefcase',
  software: 'code', transport: 'car', marketing: 'megaphone',
  salary: 'users', rent: 'home', other: 'circle',
};

/** Get a styled category icon with colored background */
function catIcon(catId, size) {
  const s = size || 16;
  const iconName = CAT_ICON_MAP[catId] || 'circle';
  const color = colorMap[catId] || '#8b8fa3';
  return `<span class="cat-icon-wrap" style="--cat-color:${color}">${icon(iconName, s)}</span>`;
}
